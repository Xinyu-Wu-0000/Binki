...
Binki = QMenu("Binki", mw)
mw.form.menuTools.addMenu(Binki)

add_word = QAction('add word', Binki)
qconnect(add_word.triggered, create_and_show_add_word_window)
Binki.addAction(add_word)
